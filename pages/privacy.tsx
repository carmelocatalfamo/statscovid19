    ...
    <WithTemplate>
      ...
      <Container>
        ...
        <Text>
          ...
          o tramite terze parti, ci sono: Cookie; Dati di utilizzo.
        </Text>
        <Text>
          ...
          Servizio. Nei casi in cui questa Applicazione indichi alcuni Dati come
          ...
          utilizzati da questa Applicazione, ove non diversamente precisato, ha
          la finalità di fornire il Servizio richiesto dall&apos;Utente, oltre
        ...
        <Text>
          ...
          <ul>
            ...
            <li>
              ...
              interesse pubblico o per l&apos;esercizio di pubblici poteri di
        ...
        <Text>
          <strong>Luogo</strong>
          <br />I Dati sono trattati presso le sedi operative del Titolare ed in
        ...
        <Text>
          ...
          dettagli sul trattamento di Dati Personali o chiedere informazioni al
        ...
        <Text>
          ...
          fraudolente, nonché per le seguenti finalità: Statistica.
        </Text>
        <Text>
          Per ottenere informazioni dettagliate sulle finalità del trattamento e
          sui Dati Personali trattati per ciascuna finalità, l’Utente può fare
          riferimento alla sezione “Informazioni dettagliate sul trattamento dei
          Dati Personali”.
        </Text>
        <Divider />
        ...
        <Text>
          <ul>
            <li>
              ...
              LLC oppure da Google Ireland Limited, a seconda della posizione in
              cui questa Applicazione viene utilizzata, (“Google”). Google
              utilizza i Dati Personali raccolti allo scopo di tracciare ed
              esaminare l’utilizzo di questa Applicazione, compilare report e
        ...
        <Text>
          ...
          <ul>
            ...
            <li>
              <strong>ottenere la limitazione del trattamento.</strong> Quando
            ...
            <li>
              <strong>proporre reclamo.</strong> L’Utente può proporre un
              reclamo all’autorità di controllo della protezione dei dati

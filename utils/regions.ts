export const regions = [
  ...
  { code: 8, name: 'Emilia-Romagna', slug: 'emilia-romagna' },
  { code: 6, name: 'Friuli Venezia Giulia', slug: 'friuli-venezia-giulia' },
  ...
  { code: 21, name: 'P.A. Bolzano', slug: 'pa-bolzano' },
  { code: 22, name: 'P.A. Trento', slug: 'pa-trento' },
  ...
  { code: 2, name: "Valle d'Aosta", slug: 'valle-daosta' },
